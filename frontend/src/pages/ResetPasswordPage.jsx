...
const ResetPasswordPage = () => {
  ...
  return (
    ...
    >
      <div className="p-8">
        <h2 className="text-3xl font-bold mb-6 text-center bg-linear-to-r from-green-500 to-emerald-600 text-transparent bg-clip-text">
          Reset Password
        </h2>
        ...
        {message && <p className="text-green-500 text-sm mb-4"></p>}
      </div>
    </motion.div>
  );
};
